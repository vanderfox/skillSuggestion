 ...
 * "Architect.ArchitectSpeechletRequestStreamHandler" For this to work, you'll also need to build
 * this project using the {@code lambda-compile} Ant task and upload the resulting zip file to power
 * your function.
 */
public final class ArchitectSpeechletRequestStreamHandler extends SpeechletRequestStreamHandler {
    private  static final Logger log = LoggerFactory.getLogger(ArchitectSpeechletRequestStreamHandler.class)
    ...
    public ArchitectSpeechletRequestStreamHandler() {
        super(new com.vanderfox.architect.ArchitectSpeechlet(), supportedApplicationIds);
    }
